...
@RestController
@RequestMapping("/api/jawnzgateway-kafka")
public class JawnzgatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JawnzgatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JawnzgatewayKafkaResource(KafkaProperties kafkaProperties) {
